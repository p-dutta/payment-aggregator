...
@NoArgsConstructor
@Builder
public class TransactionCreateRequest extends RequestPayload {
    ...
    @NotNull(message = "transaction_init_id can't be empty")
    @JsonProperty("transaction_init_id")
    private UUID transactionInitId;
    ...
    @JsonProperty("mfs_gateway_id")
    private long mfsGatewayId;
